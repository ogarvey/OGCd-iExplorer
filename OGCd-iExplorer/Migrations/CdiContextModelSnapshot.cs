...
namespace OGCdiExplorer.Migrations
{
    ...
    partial class CdiContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OGCdiExplorer.Models.CdiSector", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("CdiFileId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("CdiFileId");

                    b.ToTable("CdiSectors");
                });
            ...
            modelBuilder.Entity("OGCdiExplorer.Models.CdiSector", b =>
                {
                    b.HasOne("OGCdiExplorer.Models.CdiFile", "CdiFile")
                        .WithMany()
                        .HasForeignKey("CdiFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CdiFile");
                });
